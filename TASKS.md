...
- [x] Identify existing framework, package manager, file structure, and build scripts.
- [x] Record that the repository is empty and has no working code to preserve.
- [x] Create `PROJECT_VISION.md`.
- [x] Create `GAME_DESIGN_DOCUMENT.md`.
- [x] Create `ART_DIRECTION.md`.
- [x] Create `TECH_STACK.md`.
- [x] Create `TASKS.md`.
- [x] Create `PERFORMANCE_BUDGET.md`.
- [x] Commit Phase 1 documentation.
...
- [ ] Native Capacitor iOS and Android projects.
- [ ] Real authored GLB character and environment assets.
- [ ] Leaderboards.
- [ ] Missions and daily rewards.
- [ ] Upgrade economy.
- [ ] Audio asset pass.
